...
create_generated_clock -name ethClk312MHz [get_pins {GEN_SGMII.U_MarvelWrap/U_1GigE/U_sysClk312/O}]
create_generated_clock -name ethClk125MHz [get_pins {GEN_SGMII.U_MarvelWrap/U_1GigE/U_PLL/CLKOUT1}] 
