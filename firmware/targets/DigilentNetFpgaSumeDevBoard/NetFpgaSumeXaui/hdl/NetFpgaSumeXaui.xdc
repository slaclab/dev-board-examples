...
set_property PACKAGE_PIN A6  [get_ports {ethRxP[0]}]
set_property PACKAGE_PIN A5  [get_ports {ethRxN[0]}]
set_property PACKAGE_PIN B4  [get_ports {ethTxP[0]}]
set_property PACKAGE_PIN B3  [get_ports {ethTxN[0]}]

# ETH MGT Ports (ETH2_TX_P/N)
set_property PACKAGE_PIN B8  [get_ports {ethRxP[1]}]
set_property PACKAGE_PIN B7  [get_ports {ethRxN[1]}]
set_property PACKAGE_PIN C2  [get_ports {ethTxP[1]}]
set_property PACKAGE_PIN C1  [get_ports {ethTxN[1]}]

# ETH MGT Ports (ETH3_TX_P/N)
set_property PACKAGE_PIN C6  [get_ports {ethRxP[2]}]
set_property PACKAGE_PIN C5  [get_ports {ethRxN[2]}]
set_property PACKAGE_PIN D4  [get_ports {ethTxP[2]}]
set_property PACKAGE_PIN D3  [get_ports {ethTxN[2]}]

# PGP MGT Ports (ETH4_TX_P/N)
set_property PACKAGE_PIN D8 [get_ports {ethRxP[3]}]
set_property PACKAGE_PIN D7 [get_ports {ethRxN[3]}]
