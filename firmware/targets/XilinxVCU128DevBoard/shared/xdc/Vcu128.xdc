...
set_property -dict { PACKAGE_PIN AC28 IOSTANDARD ANALOG } [get_ports { vPIn }]
set_property -dict { PACKAGE_PIN AD27 IOSTANDARD ANALOG } [get_ports { vNIn }]

set_property -dict { PACKAGE_PIN BM29  IOSTANDARD LVCMOS12 } [get_ports { extRst }]
